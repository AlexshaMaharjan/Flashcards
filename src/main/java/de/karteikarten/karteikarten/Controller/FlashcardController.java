...
public class FlashcardController {
    ...
    public String filterFlashcards(@RequestParam(value = "tags", required = false) String tagIds, Model model) {
        ...
        List<Flashcard> filteredFlashcards = repository.findFlashcardsByTagIds(tagIdList);
